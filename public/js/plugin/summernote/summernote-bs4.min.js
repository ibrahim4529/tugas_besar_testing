...
(function(global, factory) {
    ...
    var WrappedRange = (function() {
        ...
        WrappedRange.prototype.normalize = function() {
            ...
            var startPoint = this.isCollapsed() ? endPoint : getVisiblePoint(this.getStartPoint(), !0);
    ...
    var TableResultAction = function(startPoint, where, action, domTable) {
        ...
        function addCellInfoToVirtual(row, cell) {
            ...
            setVirtualTablePosition(row.rowIndex, cellIndex, row, cell, cellHasRowspan, cellHasColspan, !1);
            var rowspanNumber = cell.attributes.rowSpan ? parseInt(cell.attributes.rowSpan.value, 10) : 0;
            if (rowspanNumber > 1) {
                for (var rp = 1; rp < rowspanNumber; rp++) {
                    var rowspanIndex = row.rowIndex + rp;
                    adjustStartPoint(rowspanIndex, cellIndex, cell, isThisSelectedCell);
                    setVirtualTablePosition(rowspanIndex, cellIndex, row, cell, !0, cellHasColspan, !0)
                }
            }
            ...
            if (colspanNumber > 1) {
                for (var cp = 1; cp < colspanNumber; cp++) {
                    ...
                    setVirtualTablePosition(row.rowIndex, cellspanIndex, row, cell, cellHasRowspan, !0, !0)
                }
            }
        }
    ...
    var Handle = (function() {
        ...
        Handle.prototype.update = function(target) {
            ...
            if (isImage) {
                ...
                var imageSize = {
                    w: $image.outerWidth(!1),
                    h: $image.outerHeight(!1)
                };
                $selection.css({
                    display: 'block',
                    left: pos.left,
    ...
    var HelpDialog = (function() {
        ...
        HelpDialog.prototype.initialize = function() {
            var $container = this.options.dialogsInBody ? this.$body : this.$editor;
            var body = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.9</a> Â· ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> Â· ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', '</p>'].join('');
            this.$dialog = this.ui.dialog({
    ...
    $$1.fn.extend({
        summernote: function() {
            ...
            options.langInfo = $$1.extend(!0, {}, $$1.summernote.lang['en-US'], $$1.summernote.lang[options.lang]);
            options.icons = $$1.extend(!0, {}, $$1.summernote.options.icons, options.icons);
